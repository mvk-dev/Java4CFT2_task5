...
ALTER TABLE tpp_ref_product_register_type
    ADD FOREIGN KEY (product_class_id) REFERENCES tpp_ref_product_class (id);

ALTER TABLE tpp_ref_product_register_type
    ADD FOREIGN KEY (account_type_id) REFERENCES tpp_ref_account_type (id);
...
ALTER TABLE tpp_product_register
    ADD FOREIGN KEY (type_id) REFERENCES tpp_ref_product_register_type (id);
...
(
    ...
    registry_type_id bigint references tpp_ref_product_register_type(id)
);
